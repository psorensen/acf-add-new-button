         ...
         if(posttypes.length == 1) {
            ...
            if($(this).is('.row-clone .acf_relationship')) {
               if($(this).is('.row_layout .acf_relationship')) {
                  $(this).closest('tr').find('.label').prepend('<ul class="hl"><li class="right"><a href="' + fiber_custom.admin_url + 'post-new.php?post_type=' + posttypes + '&asran-colorbox=true" class="acf-button add-post cboxElement iframe repeater">Add New</a></li></ul>');
               } else {
                  ...
                  $(this).closest('table').find('tr > *:eq(' + col + ')').prepend('<ul class="hl"><li class="right"><a href="' + fiber_custom.admin_url + 'post-new.php?post_type=' + posttypes + '&asran-colorbox=true" class="acf-button add-post cboxElement iframe repeater">Add New</a></li></ul>');
               }
            } else {
               ...
               if(!$(this).is('.row .acf_relationship')) {
                  ...
                  $(this).closest('.field-relationship').find('p').append('<ul class="hl clearfix repeater-footer"><li class="right"><a href="' + fiber_custom.admin_url + 'post-new.php?post_type=' + posttypes + '&asran-colorbox=true" class="acf-button add-post cboxElement iframe non-repeater">Add New</a></li></ul>');
